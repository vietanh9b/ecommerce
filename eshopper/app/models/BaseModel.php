...
// neu truyen false thi danh cho cau lenh them sua
    ...
    // public function loadAllRows($query = []) {
    //     if (empty($query)) {
    //         // Handle the case where the query is empty (provide a default query or return an error)
    //         return false;
    //     }
    
    //     $this->setQuery($query); // Set the query in the BaseModel
    //     $result = $this->execute();
